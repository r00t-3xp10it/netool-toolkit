...
# $Id$ V3.3 Author: pedr0 Ubuntu [r00t-3xp10it]
...
# ------------------------------------
        def initialize(info={})
                super(update_info(info,
                        'Name'          => 'Post-Exploitation [my-auxiliary.rb] V3.3',
                        'Description'   => %q{
...
# ------------------------------------
       ...
       print_line("  | 'automate our post-exploitation tasks' |")
